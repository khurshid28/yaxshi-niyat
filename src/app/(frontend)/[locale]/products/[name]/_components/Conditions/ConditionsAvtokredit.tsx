...
export const ConditionsAvtokredit = ({ calcData }: { calcData: Calc }) => {
  const t = useTranslations('products.avtokredit')
  ...
  const data = [
    ...
    },
    {
      ...
      text: t('conditions.2.text', { downPaymentPercent: calcData.avtokredit.downPaymentPercent }),
    ...
    },
    {
      ...
      text: t('conditions.3.text', {
        maxLoanAmount: new Intl.NumberFormat('ru-RU').format(calcData.avtokredit.maxLoanAmount),
      }),
    ...
    },
    {
      ...
      text: t('conditions.4.text', { maxTermMonths: calcData.avtokredit.maxTermMonths }),
    ...
    {
      title: t('conditions.6.title'),
      text: t('conditions.6.text'),
      description: t('conditions.6.description'),
      document: t('conditions.6.document'),
    },
    {
    ...
    {
      title: t('conditions.9.title'),
      text: t('conditions.9.text'),
      description: t('conditions.9.description'),
      document: t('conditions.9.document'),
    },
  ]
  return (
          ...
          <div className="relative overflow-hidden mt-[24px] bg-[#FFFFFF] rounded-[40px] py-[32px] px-[48px]">
            ...
            {data.map((item, index, arr) => {
              return (
                <div
                  key={item.title}
                  className={`flex row-to-col-md gap-y-[16px] justify-between ${index !== arr.length - 1 ? 'border-dashed border-b-[2px] border-[#1C40581F]' : ''}  py-[20px]`}
                >
